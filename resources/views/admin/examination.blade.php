        ...
        <div id="page-wrapper">
          ...
          <div class="row">
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"><a href="{{route('admin_examination')}}">List</a></li>
              <li role="presentation"><a href="{{route('admin_create_examination')}}">Create Exam</a></li>
            ...
            <table class="table">
              ...
              <tbody>
                @foreach($exams as $etal)
                  <tr>
                    <td><a href="#">{{$etal->question}}</a></td>
                    <td>{{$etal->created_at->toDayDateTimeString()}}</td>
                    <td>
                      <a href="{{route('admin_edit', ['id'=> $etal->id])}}" class="btn btn-info btn-xs">
