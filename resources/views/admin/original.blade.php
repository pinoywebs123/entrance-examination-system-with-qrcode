        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-primary row">
              <div class="panel-heading">
                <h3 class="text-center">Enter New Original No.</h3>
              </div>
              <div class="panel-body">
                ...
                @endif
                <form class="col-md-6 col-md-offset-3" action="{{route('admin_original_check')}}" method="POST">
                  <div class="form-group {{$errors->has('original') ? 'has-error': ''}}">
                    <input type="text" name="original" class="form-control input-lg" required="">
                  </div>
