...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <h2 class="text-center">Edit Examination Question</h2>
          <div class="row">
            ...
            @endif
            <form class="col-md-6 col-md-offset-3" action="{{route('admin_exam_update', ['id'=> $find->id])}}" method="POST">
              <div class="form-group">
                <label>Enter New Questions</label>
                <textarea name="question" class="form-control">{{$find->question}}</textarea>
               
              </div>
              <div class="form-group">
                <label>Enter the answer</label>
                <input type="text" name="answer" class="form-control" placeholder="My answer here" required="" value="{{$find->answer->answer}}">
              </div>
              <h3 class="text-center">Enter choices below</h3>

              <div class="form-group">
                
                <input type="text" name="a" class="form-control" placeholder="choice 1" required="" value="{{$find->a}}">
              </div>
              <div class="form-group">
               
                <input type="text" name="b" class="form-control" placeholder="choice 2" required="" value="{{$find->b}}">
              </div>
              <div class="form-group">
               
                <input type="text" name="c" class="form-control" placeholder="choice 3" required="" value="{{$find->c}}">
              </div>
              <div class="form-group">
               
                <input type="text" name="d" class="form-control" placeholder="choice 4" required="" value="{{$find->d}}">
              </div>
              <div class="form-group">
