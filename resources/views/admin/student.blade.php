        ...
        <div id="page-wrapper">
          ...
          <div class="row">
            <table class="table">
              ...
              <tbody>
                @foreach($students as $etal)
                  <tr>
                    <td>{{$etal->original}}</td>
                    @if($etal->student)
                       <td>{{$etal->student->fname}} {{$etal->student->lname}}</td>
                        <td>{{$etal->student->contact}}</td>
                        <td>{{$etal->created_at->toDayDateTimeString()}}</td>
                    @else
                      <td>Exam not Taken</td>
                      <td>Exam not Taken</td>
                      <td>Exam not Taken</td>
                     @endif
                    <td>
                      <a href="{{route('admin_student_answer', ['id'=> $etal->id])}}" class="btn btn-info btn-xs">View</a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
